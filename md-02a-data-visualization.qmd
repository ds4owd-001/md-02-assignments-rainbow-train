...
\
- take the gapminder object, use the pipe to send it into the filter function, and then show only rows/observations for the year 2007, store the results in gapminder_2007 using the assignment operator
